...
// ─────────────────────────────────────────────────────────
// Card แต่ละใบ — picture + info + bin + setting
// ─────────────────────────────────────────────────────────
"use client";
    ...
    <>
      <div className={styles.card}>
        ...
        <div className={styles.info}>
          ...
          {/* Date range — เฉพาะ temporary */}
          {coupon.status === "temporary" && coupon.dateFrom && coupon.dateTo && (
            <p className={styles.dateRange}>
              📅 {coupon.dateFrom} → {coupon.dateTo}
            </p>
          )}

          {/* Bottom row: claim + price */}
          <div className={styles.bottomRow}>
            <span className={styles.claim}>
              {coupon.claimPerMonth}x / month
            </span>
      ...
      {showDelete && (
        <DeleteConfirm
          ...
          onConfirm={() => { onDelete(coupon.id); setShowDelete(false); }}
