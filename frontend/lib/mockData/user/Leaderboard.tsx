// lib/mockData/user/Leaderboard.ts
...
export type LeaderboardData = {
  month: string;              // เช่น "March 2025"
  currentUserId: string;      // ไว้ highlight user ตัวเอง
  entries: LeaderboardEntry[];
};

// ── Mock data — intentionally random order ────────────────
// leaderboard component จะ sort เอง
export const leaderboardData: LeaderboardData = {
  month: "March 2025",
  currentUserId: "7",         // mock ว่า user ปัจจุบันคือ id "7"
  ...
  entries: [
    ...
    { id: "7",  name: "Anuwat Ponsri",     tokens: 120, bottles: 60  }, // ← current user
