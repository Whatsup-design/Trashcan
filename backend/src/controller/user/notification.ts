...
} from "../../services/user/notification.js";
...
export async function UserNotificationCountController(req: Request, res: Response) {
  try {
    const studentId = getStudentId(req);
    ...
    const unreadCount = await getUserNotificationCount(studentId);
